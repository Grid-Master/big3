...
interface IForm extends Omit<Omit<ITeam, 'id'>, 'imageUrl'> {
  image: any;
}
...
const AddTeam: FC = () => {
  ...
  const submitHandler: SubmitHandler<any> = async (data: IForm) => {
    let imagePath = null;
      ...
      <form className={styles.form} onSubmit={methods.handleSubmit(submitHandler)}>
        ...
        <div className={styles.formContainer}>
          <div onClick={handleAddPhoto} className={styles.imageContainer}>
            ...
            />
            {errors.image?.type === 'required' && <div>photo error</div>}
          </div>
