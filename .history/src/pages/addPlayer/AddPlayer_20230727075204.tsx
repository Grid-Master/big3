...
const AddPlayer: FC = () => {
  ...
  const { avatarUrl, name, number, position, team, weight, height } =
  ...
  console.log(errors.avatarUrl?.type === 'required');
      ...
      <form onSubmit={methods.handleSubmit(submitHandler)} className={styles.form}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.inputsContainer}>
            <div>
              <Input name="name" type="text" label="Name" value={n ? conference : ''} />
              <SingleSelect name="position" label="Position" query={getPositions} />
              <SingleSelect name="team" label="Team" query={getAllTeams} />
