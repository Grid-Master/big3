...
import { getToken } from './modules/authorization/authorizationSlice';
import { selectAlertIsShow } from './modules/alert/alertSelector';
...
function App() {
  ...
  const alertShowed = useAppSelector(selectAlertIsShow);
  ...
  return (
    <div className={styles.app}>
      ...
      {alertShowed && <Alert isSuccess={false} />}
    </div>
  );
}
